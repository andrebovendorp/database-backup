    ...
    def create_backup(self) -> BackupResult:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                tar_cmd = ["tar", "-czf", backup_file_path,
                           "-C", str(dump_dir), "."]
                ...
                backup_result.backup_size_bytes = self._get_file_size(
                    backup_file_path)
                backup_result.end_time = datetime.now()

                self.logger.info(
                    f"MongoDB backup completed successfully: {backup_file_path}")
    ...
    def restore_backup(self, backup_file_path: str) -> bool:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                mongorestore_cmd = self._build_mongorestore_command(
                    str(dump_dir))
